...
export default [
  ...
  route("dropoffs/:eventId/book", "routes/dropoffs.book.tsx"),
  ...
  layout("routes/admin.layout.tsx", [
    ...
    route("admin/notification-recipients", "routes/admin.notification-recipients.tsx"),
    ...
    route("admin/users/:id/appointments", "routes/admin.users.appointments.tsx"),
    ...
    route("admin/booking-events", "routes/admin.booking-events.tsx"),
    route("admin/booking-events/new", "routes/admin.booking-events.new.tsx"),
    route("admin/booking-events/:id", "routes/admin.booking-events.detail.tsx"),
    route("admin/booking-events/:id/edit", "routes/admin.booking-events.edit.tsx"),
