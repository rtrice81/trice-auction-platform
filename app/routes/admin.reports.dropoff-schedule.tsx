...
const operationalStatuses = new Set(["scheduled", "checked_in", "completed", "no_show", "last_minute_cancelled", "waitlisted", "cancelled"]);
...
function statusLabel(status: string) { return operationalStatuses.has(status) ? status.replaceAll("_", " ").replace(/\b\w/g, (letter) => letter.toUpperCase()) : status; }
