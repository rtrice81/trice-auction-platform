...
export async function action({ request, params }: Route.ActionArgs) {
  ...
  const result = await updateManagedUser(env.trice_auction_db, {
    ...
    consignorId: String(form.get("consignorId") || ""),
