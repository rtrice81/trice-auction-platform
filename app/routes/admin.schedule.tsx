  ...
  return (
    <main className="min-h-screen bg-stone-50 text-stone-900">
      <div className="mx-auto max-w-7xl px-6 py-12">
        <header className="flex flex-wrap items-end justify-between gap-5 border-b border-stone-200 pb-8"><div><p className="text-sm font-semibold tracking-[0.18em] text-amber-700 uppercase">Trice Auctions · Administration</p><h1 className="mt-2 text-4xl font-bold">Drop-Off Events</h1><p className="mt-2 text-stone-600">Only saved, open future/current events are visible to customers.</p></div><Link to="/admin/schedule/new" className="rounded bg-stone-900 px-4 py-2 font-semibold text-white">New Drop-Off Event</Link></header>
