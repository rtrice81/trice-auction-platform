...
export default function NewCustomer({ loaderData, actionData }: Route.ComponentProps) {
  ...
  return <main className="mx-auto max-w-2xl p-8"><Link to={returnTo || "/admin/users"}>← Back</Link><h1 className="mt-4 text-3xl font-bold">Create User</h1><p className="mt-2 text-stone-600">The temporary password is sent only to Better Auth and must be changed after the user signs in.</p>
