...
type AppointmentDetail = { id: number; appointmentDate: string; description: string | null; status: string; adminNotes: string | null; loadType: string; loadCapacityPoints: number; firstName: string | null; lastName: string | null; email: string; phone: string | null; };
