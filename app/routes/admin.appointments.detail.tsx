...
export default function AdminAppointmentDetail({ loaderData, actionData }: Route.ComponentProps) {
  ...
  return <PageShell><div className="max-w-5xl"><PageIntro eyebrow="Trice Auctions · Administration" title={`Appointment #${appointment.id}`}>{formatAppointmentStatusLabel(appointment.status)} · {appointment.appointmentDate}</PageIntro>
