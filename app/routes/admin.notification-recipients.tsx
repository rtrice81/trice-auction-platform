...
export async function action({ request }: Route.ActionArgs) {
  ...
  const result = await saveInternalAppointmentRecipient(env.trice_auction_db, {
    ...
    receiveRegistration: form.get("receiveRegistration") === "on" ? 1 : 0,
  });
