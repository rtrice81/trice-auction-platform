...
export default function DropoffEventDetail({ loaderData, actionData }: Route.ComponentProps) {
  ...
  return (
    <main className="mx-auto max-w-5xl p-8">
      ...
      <section className="mt-8"><h2 className="text-2xl font-bold">Appointments</h2><div className="mt-3"><AppointmentSummaryList appointments={event.appointments}/></div></section>
